...
-- sel	=>  Location: PIN_V10,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \y~0_combout\ = (\sel~combout\ & (\b~combout\(0))) # (!\sel~combout\ & ((\a~combout\(0))))
...
-- Equation(s):
-- \y~1_combout\ = (\sel~combout\ & (\b~combout\(1))) # (!\sel~combout\ & ((\a~combout\(1))))
...
-- Equation(s):
-- \y~2_combout\ = (\sel~combout\ & ((\b~combout\(2)))) # (!\sel~combout\ & (\a~combout\(2)))
...
-- Equation(s):
-- \y~3_combout\ = (\sel~combout\ & ((\b~combout\(3)))) # (!\sel~combout\ & (\a~combout\(3)))
...
-- Equation(s):
-- \y~4_combout\ = (\sel~combout\ & ((\b~combout\(4)))) # (!\sel~combout\ & (\a~combout\(4)))
...
-- Equation(s):
-- \y~5_combout\ = (\sel~combout\ & (\b~combout\(5))) # (!\sel~combout\ & ((\a~combout\(5))))
...
-- Equation(s):
-- \y~6_combout\ = (\sel~combout\ & ((\b~combout\(6)))) # (!\sel~combout\ & (\a~combout\(6)))
...
-- Equation(s):
-- \y~7_combout\ = (\sel~combout\ & ((\b~combout\(7)))) # (!\sel~combout\ & (\a~combout\(7)))
