...
template<typename T>
//! Classe Node, representa um elemento da LinkedList
//! e suas propriedades
class Node {
 public:
    //! Construtor padrão
...
//! Classe LinkedList, implementa uma estrutura de dados
...
class LinkedList {
 public:
    ...
    LinkedList();
    //! Destrutor padrão de LinkedList
    ~LinkedList();
...
template<typename T>
structures::Node<T>* structures::LinkedList<T>::node_at(std::size_t index) {
