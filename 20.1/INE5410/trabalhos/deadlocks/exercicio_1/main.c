...
// Na thread do worker1 o mutex_total só era ocupado após a chamada de operacao_worker1()
// enquanto na thread worker2, o mutex_total era lockado assim que a operação começava, caso o
// escalonador decidisse trocar de contexto após rodar operacao_worker1, a thread worker1 ficaria
// pra sempre esperando o mutex_total enquanto a thread worker2 ficaria sempre esperando o sem_lista
// causando uma relação circular
